...
const handleServices = (e) => {
  ...
  <div className='form-page'>
      ...
      <form onSubmit={(e) => updateParty(e)}>
        ...
        <label>
          <span>Descrição:</span>
         <textarea placeholder='Conte mais sobre a festa...' required  onChange={(e) => setParty({ ...party, description: e.target.value})}></textarea>
        </label>
        <label>
          <span>Orçamento:</span>
          <input type="number" placeholder='Quanto pretende investir?' required onChange={(e) => setParty({ ...party, budget: e.target.value})}/>
        </label>
        <label>
          <span>Imagem:</span>
          <input type="text" placeholder='Insira a URL da imagem' required  onChange={(e) => setParty({ ...party, image: e.target.value})}/>
        </label>
          <div>
